			...
			<tbody>
				<tr valign="top">
					...
					<td>
						...
						<p class="description"><?php _e("An answer will be sent to this email", $this->options['namespace'])?></p>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<label><input type="checkbox" name="admin" <?php checked($data['admin']) ?>> <?php _e('Create a temporary admin account',$this->options['namespace'])?></label>
						<p class="description">
