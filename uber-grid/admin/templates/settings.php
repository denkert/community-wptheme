<div class="wrap">
	...
	<form method="post" action="options.php" id="uber-grid-settings">
		...
		<ul>
			...
			<li class="clear"><h3><?php _e('Image Processing', 'uber-grid') ?></h3></li>
			<li class="clear">
			...
			<li class="clear"><h3><?php _e('Lightbox integration', 'uber-grid') ?></h3></li>
			<li class="clear">
			...
			<li class="clear"><h4><?php _e('PrettyPhoto options', 'uber-grid') ?></h4></li>
			<li class="clear">
			...
			<li class="clear"><h4><?php _e('Custom lightbox options', 'uber-grid') ?></h4></li>
			<li class="clear">
				<label class="asg-options-label"><?php _e('Link custom rel attribute value', 'uber-grid') ?></label>
				<p class="inputs">
					<input name="uber_grid_link_rel" class="regular-text" type="text" value="<?php echo esc_attr(get_option('uber_grid_link_rel')) ?>">
					<em><?php _e('If your custom lightbox requires a specific rel attribute value, you can enter it here.', 'uber-grid') ?></em>
				</p>
			</li>
			<li class="clear">
				<label class="asg-options-label"><?php _e('Link class', 'uber-grid') ?></label>
				<p class="inputs">
					<input name="uber_grid_link_class" class="regular-text" type="text" value="<?php echo esc_attr(get_option('uber_grid_link_class')) ?>">
					<em><?php _e('If your custom lightbox requires a specific class, you can enter it here.', 'uber-grid') ?></em>
				</p>
			</li>
			<li class="clear">
				<label class="asg-options-label"><?php _e('Custom attribute name', 'uber-grid') ?></label>
				<p class="inputs"><input name="uber_grid_link_custom_attr_name" class="regular-text" type="text" value="<?php echo esc_attr(get_option('uber_grid_link_custom_attr_name')) ?>"></p>
			</li>
			<li class="clear">
				<label class="asg-options-label"><?php _e('Custom attribute value', 'uber-grid') ?></label>
				<p class="inputs"><input name="uber_grid_link_custom_attr_value" class="regular-text" type="text" value="<?php echo esc_attr(get_option('uber_grid_link_custom_attr_value')) ?>"></p>
			</li>
		</ul>
		<?php submit_button(); ?>
	</form>
