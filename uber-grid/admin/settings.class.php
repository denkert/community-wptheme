...
class UberGrid_Settings{
	...
	function _admin_menu(){
		add_options_page(__('UberGrid', 'uber-grid'), __('UberGrid', 'uber-grid'), 'manage_options', 'uber-grid-options', array($this, 'build_option_pages'));
	}
	
	function _admin_init(){
		$settings = array(
			'uber_grid_use_external_stylesheet' => 'intval',
			'uber_grid_enable_caching' => 'intval',
			'uber_grid_force_new_jquery' => 'intval',
			'uber_grid_shortcode_hack' => 'intval',
			'uber_grid_lightbox' => 'stripslashes',
			'uber_grid_link_rel' => 'stripslashes',
			'uber_grid_link_custom_attr_name' => 'stripslashes',
			'uber_grid_link_custom_attr_value' => 'stripslashes',
			'uber_grid_link_class' => 'stripslashes',
