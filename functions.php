...
function community_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'community' ),
		'social' => __('Social Menu', 'community'),
	) );
...
function community_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widgets', 'community' ),
		'id'            => 'sidebar-2',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
...
function community_scripts() {
	...
	wp_enqueue_script( 'community-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'community-masonry', get_template_directory_uri() . '/js/masonry-settings.js', array('masonry'), '20140401', true );

	wp_enqueue_script( 'community-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
